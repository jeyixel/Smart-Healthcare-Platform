...
export function PatientAiSuggestionsContent() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        setHistoryError(getErrorMessage(err, "Failed to load medical history."));
      } finally {
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-2xl font-bold">AI Health Suggestions</h2>
