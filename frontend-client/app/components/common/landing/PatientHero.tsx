      ...
      <div className={styles.heroBody}>
        ...
        <div className={styles.heroCopy}>
          ...
          <div className={styles.heroActions}>
            {isAuthenticated ? (
              <>
                <Link href="/login" className={styles.ctaPrimary} id="hero-book-btn">
                  Book Appointment
              ...
              <>
                <Link href="/login" className={styles.ctaPrimary} id="hero-login-btn">
                  Book Appointment
                  <svg className={styles.ctaArrow} width="18" height="18"
                       viewBox="0 0 24 24" fill="none" stroke="currentColor"
                       strokeWidth="2.5" aria-hidden="true">
                ...
                <Link href="/register" className={styles.ctaAuthOutline} id="hero-register-btn">
                  Create Account
                </Link>
                <Link href="#services" className={styles.ctaSecondary} id="hero-services-btn">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
